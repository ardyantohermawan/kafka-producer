...
var (
	brokerList  = flag.String("brokers", "192.168.0.116:9092,192.168.0.116:9093,192.168.0.116:9094", "The comma separated list of brokers in the Kafka cluster")
	topic       = flag.String("topic", "topic", "The topic to produce to")
	key         = flag.String("key", "hello", "The key of the message to produce")
	value       = flag.String("value", "world", "The value of the message to produce")
